"""
DenseNet-121 CNN Baseline for Waste Segmentation
Fine-tunes pretrained DenseNet-121 on waste classification task.
"""
...
class DenseNet121Classifier(nn.Module):
    """DenseNet-121 with custom classifier head for 5-class waste classification."""
...
def train_densenet121(
    ...
    print("\n" + "=" * 70)
    print("DENSENET-121 CNN BASELINE TRAINING")
    print("=" * 70)
    ...
    checkpoint_path = save_path / "densenet121_best.pth"
    torch.save({
        'epoch': epoch,
    ...
    # Save metrics
    metrics_path = save_path / "metrics_densenet121.json"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train DenseNet-121 baseline.")
